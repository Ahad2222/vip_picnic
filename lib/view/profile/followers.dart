...
import 'package:vip_picnic/model/they_followed_model/they_followed_model.dart';
                        ...
                        onTap: !isFollowed!
                            ? () async {
                                await ffstore.collection(accountsCollection).doc(auth.currentUser!.uid).update({
                                  "iFollowed": FieldValue.arrayUnion([umdl!.followerId]),
                                });
                                await ffstore.collection(accountsCollection).doc(umdl!.followerId).update({
                                  "TheyFollowed": FieldValue.arrayUnion([auth.currentUser!.uid]),
                                });
                                IFollowedModel iFollowedProfile = IFollowedModel(
                                  followedId: umdl!.followerId,
                                  followedName: umdl!.followerName,
                                  followedImage: umdl!.followerImageUrl,
                            ...
                            : () async {
                                ...
                                await ffstore.collection(accountsCollection).doc(auth.currentUser!.uid).update({
                                  "iFollowed": FieldValue.arrayRemove([umdl!.followerId]),
                                });
                                await ffstore.collection(accountsCollection).doc(umdl!.followerId).update({
