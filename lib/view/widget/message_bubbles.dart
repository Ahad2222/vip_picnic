...
class MessageBubbles extends StatelessWidget {
  ...
  String? msg, time, receiveImage, senderType, mediaType, thumbnail;

  @override
  Widget build(BuildContext context) {
    return mediaType == 'image'
        ? Row(
            mainAxisAlignment: senderType == 'sender' ? MainAxisAlignment.end : MainAxisAlignment.start,
            children: [
              Hero(
                tag: 'chatMedia',
                ...
                ? Row(
                    ...
                    children: [
                      Hero(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            showMsg(context: context, msg: "Can't do that. This Video is still uploading");
                          },
                          child: Container(
                            margin: EdgeInsets.only(
                              bottom: 15,
                    ...
                    Expanded(
                      child: ChatBubble(
                        clipper: ChatBubbleClipper1(
                          type: senderType == 'receiver' ? BubbleType.receiverBubble : BubbleType.sendBubble,
                          radius: 6.0,
                          nipHeight: 18.88,
                          nipRadius: 0.0,
                        ),
                        ...
                        backGroundColor: senderType == 'receiver' ? Color(0xffE6ECF0) : kGreenColor,
                        child: Column(
