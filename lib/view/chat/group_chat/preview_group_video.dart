...
class PreviewGroupVideoScreen extends StatefulWidget {
  final String? videoPath;
  final String? userId;
  final String? chatRoomId;

  const PreviewGroupVideoScreen(
      {Key? key,
        this.videoPath,
        this.userId,
        this.chatRoomId})
  ...
  @override
  _PreviewGroupVideoScreenState createState() => _PreviewGroupVideoScreenState();
}

class _PreviewGroupVideoScreenState extends State<PreviewGroupVideoScreen> {
  String videoUrl = '';
  ...
  uploadVideo() async {
    ...
    try {
      ...
      // String compressedVideoPath = "${tempDirectory.path}/${fileName}.mp4";
      ...
      videoDocStream = ffstore.collection(groupChatCollection)
      ...
      // log("Compression starting at: ${DateTime.now()}");
      // MediaInfo? mediaInfo = await VideoCompress.compressVideo(
      //   widget.videoPath ?? "",
      //   quality: VideoQuality.DefaultQuality,
      //   deleteOrigin: false, // It's false by default
      // );
      // log("Compression ended at: ${DateTime.now()}");
      // // final uploadTask = ref.putFile(File(widget.videoPath!));
      // log("mediaInfo.filesize is: ${mediaInfo?.filesize}");
      Get.back();
      Get.back();
      // final uploadTask = ref.putFile(File(widget.videoPath!));
